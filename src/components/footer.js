...
function Footer() {
	return ( 
		<div className="bg-[#3A643B2E] px-4 md:px-2 py-12 flex flex-col flex-wrap  gap-8 md:flex-row md:justify-center ">
			<div className="md:hidden space-y-4 max-w-[300px]">
			...
			<div className="md:hidden max-w-[400px] space-y-4">
				...
				<div className="flex items-center">
					<input
						type='email'
						className="w-[200px] sm:w-auto px-2 py-4 rounded-l-[40px] focus:outline-none border border-[#3A643B] placeholder:text-[10px] sm:placeholder:text-[14px]"
