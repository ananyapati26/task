		...
		<div className="bg-[#FFFAEC] py-12 px-2">
			<div className="text-center mb-8">
				<h2 className="text-[#3A643B] inline-block text-[32px] sm:text-[48px]  font-robo text-center px-2 font-bold leading-tight ">
					...
					<hr className='hidden lg:block -mt-[13px] text-center -z-10 bg-[#C3D0C4] h-2' />
				</h2>
			</div>

			<div className='flex flex-col md:flex-row md:flex-wrap justify-center  items-center gap-4'>
				<div className='md:flex-none md:w-[650px] xl:w-[600px] text-[#3A643B] w-[328px] px-16 py-[45px] shadow-lg rounded-[20px] border-t-[5px] border-[#3A643B] space-y-4 bg-[rgba(255,255,255,1)]'>
				...
				<div className='flex flex-col gap-2 md:flex md:flex-row md:items-center md:flex-wrap md:gap-4'>
					...
					<div className='sm:flex-none text-[#3A643B] w-[328px] md:w-[320px] h-[285px] px-[28px] py-[47px] shadow-lg rounded-[20px] border-t-[5px] border-[#3A643B] space-y-5 bg-[rgba(255,255,255,1)]'>
			...
			<div className='flex flex-col md:flex-row md:flex-wrap items-center justify-center mt-4 gap-4'>
				<div className='flex flex-col md:flex-row md:flex-wrap items-center justify-center gap-3'>
					...
					<div className='w-[328px] md:w-[293px] h-[277px] rounded-[20px] px-[20px] py-[40px] border-t-[5px] border-[#3A643B] shadow-lg space-y-4 bg-[rgba(255,255,255,1)]'>
